  ...
  return (
    <Modal onClose={close}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: t.GAP }}>
        <h2 style={{ margin: 0, fontSize: t.TEXT_TITLE, fontWeight: 600 }}>Export connections</h2>
        <p style={{ margin: 0, color: t.TEXT_MUTED, fontSize: t.TEXT_BODY }}>
          Writes every workspace and every connection to one file, to carry to another machine or keep as a backup.
        </p>
        ...
        {exported && (
          <Callout tone="success">
            Exported {exported.connections} {exported.connections === 1 ? 'connection' : 'connections'} in{' '}
            {exported.workspaces} {exported.workspaces === 1 ? 'workspace' : 'workspaces'}
