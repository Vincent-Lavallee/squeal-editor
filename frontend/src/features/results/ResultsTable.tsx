    ...
    return (
        <>
            ...
            <div
                ...
                onKeyDown={onKeyDown}
                onScroll={(e) =>
                    rememberScroll(e.currentTarget.scrollTop, e.currentTarget.scrollLeft)
                }
            >
                    ...
                    <thead>
                        ...
                        sorts, and a resize is not a sort. */}
                                        <span
                                            ...
                                            className={
                                                resizing?.column === col
                                                    ? 'grid__resize grid__resize--active'
                                                    : 'grid__resize'
                                            }
                                            style={resizeHandle}
                                        ...
                                        return (
                                            <td
                                                ...
                                                style={{
                                                    ...cellBase,
                                                    ...columnSize(
                                                        columnWidths[result.columns[c] ?? ''],
                                                    ),
                                                    boxShadow: cellMarks(r, c, isEditing, dirty),
                                                }}
                                                onMouseDown={(e) =>
                                                    !isEditing && armCellDrag(r, c, e)
                                                }
                                                onMouseEnter={(e) =>
                                                    !isEditing && dragCellTo(r, c, e)
                                                }
                                                onClick={(e) =>
                                                    !isEditing && selectCell(r, c, e.shiftKey)
                                                }
                                                ...
                                                {isEditing ? (
                                                    ...
                                                    >
                                                        ...
                                                        <button
                                                            type="button"
                                                            data-testid="fk-nav"
                                                            title={`Open the row ${result.columns[c]} points at`}
                                                            style={{
                                                                flex: 'none',
                                                                display: 'inline-flex',
                                                                padding: 0,
          ...
          not only over the 8px strip it left behind on the first fast move. */}
            ...
            {jsonEditing && (
                <JsonCellDrawer
                    ...
                    onCommit={(draft) => {
                        applyEdit(jsonEditing.row, jsonEditing.col, draft);
                        setJsonEditing(null);
                    }}
                    onNull={() => {
                        applyNull(jsonEditing.row, jsonEditing.col);
                        setJsonEditing(null);
                    }}
