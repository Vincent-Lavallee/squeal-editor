...
export const loadEnvironments = createAppThunk('environments/load', async (_: void, { rejectWithValue }) => {
  try {
...
export const addEnvironment = createAppThunk('environments/add', async (name: string, { rejectWithValue }) => {
  try {
 ...
 */
export const removeEnvironment = createAppThunk('environments/remove', async (id: string, { rejectWithValue }) => {
  try {
