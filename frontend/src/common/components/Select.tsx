        ...
        <>
            <div
                ...
                style={{
                    ...
                    ...(disabled
                        ? { color: t.TEXT_FAINT, borderColor: t.BORDER, cursor: 'default' }
                        : {}),
                    ...(focused && !isBare && !isAttached && !disabled
                        ...
                        {shown.map((option, index) => (
                            <button
                                ...
                                style={{
                                    ...optionBase,
                                    ...(option.disabled
                                        ? { color: t.TEXT_FAINT, cursor: 'default' }
                                        : {}),
                                    ...(index === active && !option.disabled
                                        ? { background: t.HOVER }
                                        : {}),
                                    ...(option.value === value
                                        ? { background: t.SELECTED, color: t.ACCENT }
                                        : {}),
                                }}
